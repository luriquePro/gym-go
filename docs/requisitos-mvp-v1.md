# 📋 Requisitos MVP - GymGo

## 🎯 Objetivo

Desenvolver um MVP (Minimum Viable Product) do GymGo - aplicação para gerenciamento de check-ins em academias, seguindo os princípios SOLID e Clean Architecture.
